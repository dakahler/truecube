...
int plg_import(char filename[20])
{
	...
	int count,vertnum,faces,tempint,vert1,vert2,vert3,vert4,test4;
	...
	for (count=0;count<faces;count++) {
		...
		if (polys[count].num_verts==4) {
			...
			polys[count].num_verts=3;
			count++;
			polys[count].vertices[0].x=vertlist[vert3].x;
			polys[count].vertices[0].y=vertlist[vert3].y;
			polys[count].vertices[0].z=vertlist[vert3].z;
			polys[count].vertices[1].x=vertlist[vert4].x;
			polys[count].vertices[1].y=vertlist[vert4].y;
			polys[count].vertices[1].z=vertlist[vert4].z;
			polys[count].vertices[2].x=vertlist[vert1].x;
			polys[count].vertices[2].y=vertlist[vert1].y;
			polys[count].vertices[2].z=vertlist[vert1].z;
			polys[count].num_verts=3;
		}
		polys[count].color_r=rand()%256;
		polys[count].color_g=rand()%256;
